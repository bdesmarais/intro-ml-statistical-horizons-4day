...
```{r data}
d <- read.csv("https://raw.githubusercontent.com/bdesmarais/intro-ml-statistical-horizons-4day/main/tutorials/day4_classic_learners/05_gibler_braithwaite/data/gb20.csv")
